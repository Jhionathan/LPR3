...
const Logistc = () => {
    return (
        <div className="w-100% bg-gray-100 min-h-screen">
            <div className="max-w-screen-xl p-7 m-auto flex items-center justify-center gap-4 pt-32  max-md:flex-col">
                <div className="max-w-lg">
                    <h2 className="text-2xl font-bold mb-3 max-md:text-xl" data-aos="fade-left" data-delay="500">Área de Atuação</h2>
