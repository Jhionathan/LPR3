            ...
            <div className="max-w-screen-xl p-7 m-auto flex items-center justify-center gap-4 pt-28  max-md:flex-col">
                <div className="max-w-lg">
                    ...
                    <p className="text-sm text-justify max-md:text-xs" data-aos="fade-left" data-delay="500" >
                        ...
                        Para Goiânia e Região Metropolitana as entregas são realizadas em até 48 horas pela R3 Suprimentos.
                        No interior e no Distrito Federal, em até 72h, através de transportadoras bem selecionadas, mantendo assim um bom índice de qualidade na prestação de serviços.
